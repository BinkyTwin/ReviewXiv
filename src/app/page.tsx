      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 py-20">
        ...
        {showUploader ? (
            ...
            <div className="apple-card p-8">
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">PDF uniquement · Max 50Mo</p>
                </div>
                <Button
                  variant="ghost"
          ...
          <div className="w-full max-w-6xl space-y-20">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 animate-in" style={{ animationDelay: "400ms" }}>
              <Button
        ...
        <div className="mt-32 flex flex-col items-center gap-4 text-muted-foreground/30 animate-in" style={{ animationDelay: "500ms" }}>
